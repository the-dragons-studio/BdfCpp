...
namespace Bdf
{
	...
	public:
		 ...
		 */
		BdfList::Iterator find(BdfObject* needle) noexcept;
		 ...
		 */
		std::optional<uint64_t> findIndex(BdfObject* needle) noexcept;
		 ...
		 * 
		 */
		std::partial_ordering operator<=>(BdfList& rhs) noexcept;
		 ...
		 */
		bool operator==(BdfList& rhs) noexcept;
